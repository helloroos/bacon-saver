...
var regeneratorRuntime = __webpack_require__(/*! regenerator-runtime */ "./node_modules/regenerator-runtime/runtime.js"); // const searchForm = document.querySelector('.searchForm');
...
var searchResults = document.querySelector('#search-result-container');
var scroopleSearch = document.querySelector('#scroople-search-btn');
var searchQuery = '';
searchInput.addEventListener('keypress', function (e) {
  // e.preventDefault();
  if (e.key === 'Enter') {
    searchQuery = searchInput.value; // console.log(searchQuery);
