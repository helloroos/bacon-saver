...
var tools = document.querySelector('#tools'); // tools.addEventListener('click', () => {
//   // e.preventDefault();
//   searchQuery = mainSearchInput.value;
//   fetchSearchResults(searchQuery);
// })
