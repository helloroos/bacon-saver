...
var visibility = document.querySelectorAll('.invisible');
var searchQuery = '';
...
function fetchSearchResults(searchQuery) {
  axios({
    ...
    generateResults(res.data.results); // searchContainer.style.display = 'hidden';

    searchContainer.classList.add('hidden');
    searchInput.value = searchQuery; // searchInput.placeholder = searchQuery;
